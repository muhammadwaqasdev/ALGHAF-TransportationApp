...
class StartCarRideViewModel extends ReactiveViewModel with ApiViewModel {

  bool isRideOnRequest = true;
  bool isRideAccepted = false;
  bool isRiderArrivedForPickUp = false;
  bool isRiderStartTrip = false;
  bool isRiderRiding = false;
  bool isRiderArrivedToDestination = false;

  onRideDone() async {
    await Future.delayed(Duration(seconds: 10));
    isRiderRiding = false;
    isRiderArrivedToDestination = true;
    notifyListeners();
  }


  SetArrivedAtPickup() async {
    await Future.delayed(Duration(seconds: 10));
    isRideAccepted = false;
    isRiderArrivedForPickUp = true;
    notifyListeners();
  }
