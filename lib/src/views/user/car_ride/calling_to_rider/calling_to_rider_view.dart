              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text("Muhammad Waqas",style: TextStyling.h3.copyWith(color: AppColors.white),),
                    Text("Ringing...",style: TextStyling.h4.copyWith(color: AppColors.blue),),
                  ],
                ),
                Spacer(),
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(child: Image.asset(Assets.imagesSpeakerVector,height: 24,width: 24,)),
                    ),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Image.asset(Assets.imagesCallVector,height: 24,width: 24,)),
                      ),
                    ),
                  ],
                ),
