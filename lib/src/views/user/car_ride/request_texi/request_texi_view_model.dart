...
class RequestTexiViewModel extends ReactiveViewModel with ApiViewModel {
  ...
  Future<void> init() async {
    final directions = await runBusyFuture(apiService.getDirections(origin: origin.position, destination: LatLng(24.939725, 67.023667)));
    info = directions!;
    print(info);
    notifyListeners();
  }
  ...
  void addMarker(LatLng pos) async {
    if (origin == null || (origin != null && destination != null)) {
      ...
      // Set destination
        ...
        final directions = await runBusyFuture(apiService.getDirections(origin: origin.position, destination: pos));
        info = directions!;
        notifyListeners();
    }
  }
