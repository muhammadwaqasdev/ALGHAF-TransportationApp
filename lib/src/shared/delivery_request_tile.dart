...
class DeliveryRequestTileCard extends StatelessWidget {
  ...
  const DeliveryRequestTileCard({Key? key, required this.isRequested, this.isDelivered = false}) : super(key: key);
        ...
        children: [
          ...
          isRequested ? Row(
            ...
            children: [
              ...
              isDelivered ? Text("Delivered",style: TextStyling.h4.copyWith(color: AppColors.green),) : SmallButton(title: "Call", onTap: (){
                NavService.callingToBikeRider();
              } , isPrimary: true)
            ],
          ) : Text("Waiting",style: TextStyling.h4.copyWith(color: AppColors.grey),),
        ],
      ),
    );
  }
